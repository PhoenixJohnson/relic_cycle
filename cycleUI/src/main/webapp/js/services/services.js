...
RCycle.factory('GetItem', ['$resource', 'PRMconf', function ($resource, config) {
    return $resource('', {}, {
        'query': {
...
RCycle.factory('AuthInterceptor', ['$q', function ($q) {
    return {
