...
RCycle.controller('BelongsController', ['$scope', '$timeout', '$filter', 'ngTableParams', 'JDData', 'PRMconf','$interval', function ($scope, $timeout, $filter, ngTableParams, JDData, config, $interval) {
